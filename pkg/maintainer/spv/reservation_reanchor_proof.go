...
// reservationReanchorTransactionProofSubmitter adapts submitDiscoveredReservationReanchorProof to the
...
// but is currently unused: reservation re-anchor proof submissions are not
// yet instrumented with metrics.
