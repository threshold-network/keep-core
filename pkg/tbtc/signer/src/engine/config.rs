...
pub(crate) const TBTC_SIGNER_STATE_GENERATION_SUFFIX: &str = ".generation";
...
pub(crate) const TBTC_SIGNER_POLICY_MAX_INPUT_COUNT_ENV: &str =
    "TBTC_SIGNER_POLICY_MAX_INPUT_COUNT";
