...
// WalletProposalValidatorReservationAnchorProposal is an auto generated low-level Go binding around an user-defined struct.
type WalletProposalValidatorReservationAnchorProposal struct {
	WalletPubKeyHash [20]byte
	DepositKey       WalletProposalValidatorDepositKey
	RequestNonce     uint64
	AnchorTxFee      *big.Int
}

// WalletProposalValidatorReservationReanchorProposal is an auto generated low-level Go binding around an user-defined struct.
type WalletProposalValidatorReservationReanchorProposal struct {
...
// ValidateReservationAnchorProposal is a free data retrieval call binding the contract method 0xf9179ad2.
//
// Solidity: function validateReservationAnchorProposal((bytes20,(bytes32,uint32),uint64,uint256) proposal, ((bytes4,bytes,bytes,bytes4),bytes8,bytes20,bytes20,bytes4) depositExtraInfo) view returns(bool)
func (_WalletProposalValidator *WalletProposalValidatorCaller) ValidateReservationAnchorProposal(opts *bind.CallOpts, proposal WalletProposalValidatorReservationAnchorProposal, depositExtraInfo WalletProposalValidatorDepositExtraInfo) (bool, error) {
	var out []interface{}
	err := _WalletProposalValidator.contract.Call(opts, &out, "validateReservationAnchorProposal", proposal, depositExtraInfo)
...
//
// Solidity: function validateReservationAnchorProposal((bytes20,(bytes32,uint32),uint64,uint256) proposal, ((bytes4,bytes,bytes,bytes4),bytes8,bytes20,bytes20,bytes4) depositExtraInfo) view returns(bool)
func (_WalletProposalValidator *WalletProposalValidatorSession) ValidateReservationAnchorProposal(proposal WalletProposalValidatorReservationAnchorProposal, depositExtraInfo WalletProposalValidatorDepositExtraInfo) (bool, error) {
	return _WalletProposalValidator.Contract.ValidateReservationAnchorProposal(&_WalletProposalValidator.CallOpts, proposal, depositExtraInfo)
}

// ValidateReservationAnchorProposal is a free data retrieval call binding the contract method 0xf9179ad2.
//
// Solidity: function validateReservationAnchorProposal((bytes20,(bytes32,uint32),uint64,uint256) proposal, ((bytes4,bytes,bytes,bytes4),bytes8,bytes20,bytes20,bytes4) depositExtraInfo) view returns(bool)
func (_WalletProposalValidator *WalletProposalValidatorCallerSession) ValidateReservationAnchorProposal(proposal WalletProposalValidatorReservationAnchorProposal, depositExtraInfo WalletProposalValidatorDepositExtraInfo) (bool, error) {
	return _WalletProposalValidator.Contract.ValidateReservationAnchorProposal(&_WalletProposalValidator.CallOpts, proposal, depositExtraInfo)
}

// ValidateReservationReanchorProposal is a free data retrieval call binding the contract method 0xa57f734f.
//
// Solidity: function validateReservationReanchorProposal((bytes20,uint256,uint64,bytes20,uint256) proposal) view returns(bool)
func (_WalletProposalValidator *WalletProposalValidatorCaller) ValidateReservationReanchorProposal(opts *bind.CallOpts, proposal WalletProposalValidatorReservationReanchorProposal) (bool, error) {
	var out []interface{}
	err := _WalletProposalValidator.contract.Call(opts, &out, "validateReservationReanchorProposal", proposal)
...
//
// Solidity: function validateReservationReanchorProposal((bytes20,uint256,uint64,bytes20,uint256) proposal) view returns(bool)
func (_WalletProposalValidator *WalletProposalValidatorSession) ValidateReservationReanchorProposal(proposal WalletProposalValidatorReservationReanchorProposal) (bool, error) {
	return _WalletProposalValidator.Contract.ValidateReservationReanchorProposal(&_WalletProposalValidator.CallOpts, proposal)
}

// ValidateReservationReanchorProposal is a free data retrieval call binding the contract method 0xa57f734f.
//
// Solidity: function validateReservationReanchorProposal((bytes20,uint256,uint64,bytes20,uint256) proposal) view returns(bool)
func (_WalletProposalValidator *WalletProposalValidatorCallerSession) ValidateReservationReanchorProposal(proposal WalletProposalValidatorReservationReanchorProposal) (bool, error) {
	return _WalletProposalValidator.Contract.ValidateReservationReanchorProposal(&_WalletProposalValidator.CallOpts, proposal)
}
