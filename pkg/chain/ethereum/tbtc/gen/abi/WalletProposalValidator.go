...
// ValidateReservationAnchorProposal is a free data retrieval call binding the contract method 0xddded0a4.
//
// Solidity: function validateReservationAnchorProposal((bytes20,(bytes32,uint32),uint256) proposal, ((bytes4,bytes,bytes,bytes4),bytes8,bytes20,bytes20,bytes4) depositExtraInfo) view returns(bool)
...
// ValidateReservationReanchorProposal is a free data retrieval call binding the contract method 0x97dd538f.
//
// Solidity: function validateReservationReanchorProposal((bytes20,uint256,bytes20,uint256) proposal) view returns(bool)
