...
func TestResolvePeers(t *testing.T) {
	var tests = map[string]struct {
		...
		"mainnet network": {
			...
			expectedPeers: []string{
				"/dns4/keep.colossus.digital/tcp/3919/ipfs/16Uiu2HAm3ZwkmwUe4ivC2hGmekjZSjHhdAsw692yTEqbG71rS2pL",
				...
				"/dns4/tbtc.somaweb3.llc/tcp/3919/ipfs/16Uiu2HAmSj77bdmdiYBXUbkjvFN9dgsb5LENejp2pi35eRvkr8Ec",
