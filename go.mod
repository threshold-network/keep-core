...
replace (
	...
	github.com/keep-network/keep-common => github.com/threshold-network/keep-common v0.0.0-20251127093846-6201db898e2d
...
require (
	...
	github.com/keep-network/keep-common v0.0.0-20251127093846-6201db898e2d
