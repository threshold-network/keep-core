...
library DelayFactor {
    ...
    /// @return delayFactor Integer representing floating-point number with 16 decimals places.
    function calculate(
        ...
        // block the earliest.
        uint256 submissionStartBlock = currentRequestStartBlock + 1;
        ...
        uint256 remainingBlocks = deadlineBlock - entryReceivedBlock;

        // T_deadline - T_begin
        uint256 submissionWindow = deadlineBlock - submissionStartBlock;
        ...
        delayFactor = ((remainingBlocks * decimals / submissionWindow)**2)
             / decimals;
    }
}
