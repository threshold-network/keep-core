...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                _b.sent();
                if (!hre.network.tags.etherscan) return [3 /*break*/, 8];
                if (!BeaconSortitionPool.transactionHash) return [3 /*break*/, 6];
                return [4 /*yield*/, hre.ethers.provider.waitForTransaction(BeaconSortitionPool.transactionHash, 2, 300000)];
            case 5:
                _b.sent();
                _b.label = 6;
            case 6: return [4 /*yield*/, helpers.etherscan.verify(BeaconSortitionPool)];
            case 7:
                _b.sent();
                _b.label = 8;
            case 8:
                if (!hre.network.tags.tenderly) return [3 /*break*/, 10];
